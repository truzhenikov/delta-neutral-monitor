...
class Settings(BaseSettings):
    ...
    bot_status_timeout_sec: float = Field(default=45.0, alias="BOT_STATUS_TIMEOUT_SEC")
    ...
    aster_user_address: str = Field(default="", alias="ASTER_USER_ADDRESS")
    aster_signer: str = Field(default="", alias="ASTER_SIGNER")
    aster_signer_private_key: str = Field(default="", alias="ASTER_SIGNER_PRIVATE_KEY")
